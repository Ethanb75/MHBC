...
export default class Apparel extends Component {
  ...
  componentDidMount() {
    this.filterProductsByType('Hats');
    ...
    return (
      <div>
        <Helmet
          ...
          meta={[
            { name: 'description', content: 'Mile High Boys Club official website and merch store. Hats Catalog Page.' },
        ...
        <div className="catalogCategory">
          <h2>
            <span>
              <Link to="/">Home</Link> &rarr; <Link to="/en/Catalog">Catalog</Link> &rarr; Hats
            </span>
            <div>
