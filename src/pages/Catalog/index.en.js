...
export default class Catalog extends Component {
  ...
  filterProductsByType(productType) {
    // add the loading css
    return this.props.client.product
      .fetchQuery({ sortKey: "PRODUCT_TYPE", query: productType })
      .then((products) => {
          ...
          meta={[
            {
              name: "description",
              content:
                "Mile High Boys Club official website and merch store. Browse our catalog",
            },
            {
              name: "keywords",
